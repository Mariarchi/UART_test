...
declare -r TMP_INPUT_UART_FILE="${TESTS_BIN_FILES_PATH}/temp_UART_output_${AMBIENT_TEMPERATURE}_UART${BOARD_NAME_1}_UART${BOARD_NAME_2}.bin"
declare -r TMP_EXPECTED_UART_FILE="${TESTS_BIN_FILES_PATH}/temp_UART_expected_${AMBIENT_TEMPERATURE}_UART${BOARD_NAME_1}_UART${BOARD_NAME_2}.bin"
